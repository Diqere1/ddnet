...
//mrx
[[maybe_unused]] static const char *FONT_ICON_CROSSHAIR = "\xEF\x81\x9B"; //Прицел
[[maybe_unused]] static const char *FONT_ICON_LEAF = "\xEF\x81\xAC"; // Лепесток
[[maybe_unused]] static const char *FONT_ICON_TOGGLE_ON = "\xEF\x88\x85"; // Переключатель ON
[[maybe_unused]] static const char *FONT_ICON_TOGGLE_OFF = "\xEF\x88\x84"; // Переключатель OFF
[[maybe_unused]] static const char *FONT_ICON_SQUARE = "\xEF\x91\x9C"; // Контур прямоугольника
[[maybe_unused]] static const char *FONT_ICON_CIRCLE_DOT = "\xEF\x86\x92"; // Точка с кругом
