...
// MRX
#include "components/cheat/features/advancedeepfly.h"
#include "components/cheat/features/aimhookdummy.h"
#include "components/cheat/features/autoaled.h"
#include "components/cheat/features/avoidfreeze.h"
#include "components/cheat/features/autodummyconnect.h"
#include "components/cheat/features/autoteam.h"
#include "components/cheat/features/balancebot.h"
#include "components/cheat/features/dummyaled.h"
#include "components/cheat/features/dummycontrol.h"
#include "components/cheat/features/dummyhookcursor.h"
#include "components/cheat/features/hookfly.h"
#include "components/cheat/features/moveflybot.h"
#include "components/cheat/features/pixelwalk.h"
#include "components/cheat/features/playersvisual.h"
#include "components/cheat/features/pseudofire.h"
#include "components/cheat/features/slowwalk.h"
#include "components/cheat/features/triplehookholder.h"
#include "components/cheat/features/tas.h"
#include "components/cheat/mrxclient.h"
#include "components/cheat/visuals.h"
#include "components/cheat/features/bindwheel.h"
#include "components/cheat/mrxsimpleconfigs.h"
...
// Visual components
#include "components/cheat/visual/arraylist.h"
#include "components/cheat/visual/comandoverlay.h"
#include "components/cheat/visual/predictpositionline.h"

// Core client components referenced by menus
#include "components/spectator.h"
#include "components/touch_controls.h"
#include "components/voting.h"
...
public:
    ...
    CDummyAled m_DummyAled;
    CArrayList m_ArrayList;
    // CStatusBar m_StatusBar;
    CCommandOverlay m_CommandOverlay;
    CMoveFlyBot m_MoveFlyBot;
    CTripleHookHolder m_TripleHookHolder;
    CPixelWalk m_PixelWalk;
    CDummyHookCursor m_DummyHookCursor;
    CSlowWalk m_SlowWalk;
    CBalanceBot m_BalanceBot;
    CAdvancedDeepFly m_AdvancedDeepFly;
    CPseudofire m_Pseudofire;
    CDummyControl m_DummyControl;
    CAvoidFreeze m_AvoidFreeze;
    CAutoDummyConnect m_AutoDummyConnect;
    CAutoTeam m_AutoTeam;
    CAimHookDummy m_AimHookDummy;
    CHookFly m_HookFly;
    CPredictPositionLine m_PredictPositionLine;
    CTas m_Tas;
    CMrxClient m_MrxClient;
    CVisuals m_Visuals;
    CBindWheelMRX m_BindWheelMRX;
    CMRXSimpleConfigs m_MRXSimpleConfigs;

    // MRX Aimbot Helper
    std::unique_ptr<FHelper> m_pMrxAimbotHelper;
