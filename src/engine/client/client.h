...
class CClient : public IClient, public CDemoPlayer::IListener
{
    ...
    int m_aAckGameTick[NUM_DUMMIES] = {-1, -1, -1, -1};
    int m_aCurrentRecvTick[NUM_DUMMIES] = {0, 0, 0, 0};
    int m_aRconAuthed[NUM_DUMMIES] = {0, 0, 0, 0};
    ...
    bool m_aCodeRunAfterJoin[NUM_DUMMIES] = {false, false, false, false};
    ...
    int m_aSnapshotIncomingDataSize[NUM_DUMMIES] = {0, 0, 0, 0};
    ...
    char m_aAutomaticDummy2Name[MAX_NAME_LENGTH];
    char m_aAutomaticDummy3Name[MAX_NAME_LENGTH];
...
public:
    ...
    const char *DummyName(int DummyIndex = 1) override;
